...
/**
 * Created by Jerome Lieow on 16/01/2017.
 */

public class CountersigningOfficerNotificationDisplay extends Service {

    final int NOTIFICATION_ID = 36;

    public CountersigningOfficerNotificationDisplay() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        displayNotification("Completed Checklists", "Please review the MT-RAC submitted to you.");
        return super.onStartCommand(intent, flags, startId);
    }

    private void displayNotification(String title, String text) {
        Intent resultIntent = new Intent(this, Your_MTRAC.class);
