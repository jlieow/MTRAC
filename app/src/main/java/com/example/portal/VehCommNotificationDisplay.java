...
public class VehCommNotificationDisplay extends Service {

    final int NOTIFICATION_ID = 26;

    public VehCommNotificationDisplay() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        displayNotification("Countersigning Officer", "Please review the MT-RAC submitted to you.");
        return super.onStartCommand(intent, flags, startId);
    }

    private void displayNotification(String title, String text) {
        Intent resultIntent = new Intent(this, Countersigning_Officer.class);
