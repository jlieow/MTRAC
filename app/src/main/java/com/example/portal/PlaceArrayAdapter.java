...
/**
 * Created by Jerome_Lieow on 26/06/2017.
 */
...
public class PlaceArrayAdapter extends ArrayAdapter<PlaceArrayAdapter.PlaceAutocomplete> implements Filterable {
    ...
    private ArrayList<PlaceAutocomplete> getPredictions(CharSequence constraint) {
        if (mGoogleApiClient != null) {
            ...
            while (iterator.hasNext()) {
                ...
                Log.i(TAG, "Prediction is: " + prediction.getFullText(null));
            }
    ...
    class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId, CharSequence description) {
            ...
            //Used to replace any word that appear in the description--------------------
            List<String> Country = new ArrayList<String>();
            Country.add("Singapore");
//            Country.add("Australia");

            for (String CountryName: Country) {
                description = description.toString().replace(CountryName, "");
            }
            //Used to replace any word that appear in the description--------------------
